        ...
        <div className="mt-16 text-center">
          <div className="bg-eco-lightest max-w-3xl mx-auto rounded-xl p-8 shadow-md">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a href="tel:+9821986005" className="bg-white border border-eco text-eco-dark hover:bg-eco-lightest px-6 py-3 rounded-lg transition-colors inline-flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
