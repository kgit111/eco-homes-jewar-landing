...
const ContactForm = () => {
  ...
  const contactInfo = [
    {
      title: "Address",
      content: "Yamuna Eco Homes, Near Yamuna Expressway, Jewar, Gautam Buddha Nagar, Uttar Pradesh",
      icon: (
    ...
    {
      title: "Email Us",
      content: "yamunaecohomes@gmail.com",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="contact" className="section-padding bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">
          Interested in learning more about Yamuna Eco Homes? Fill out the form below, 
            ...
            <div className="md:col-span-2 bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-start">
                    <div className="bg-eco-lightest p-3 rounded-full text-eco mr-4">
                      {info.icon}
                    </div>
                    <div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-eco-lightest p-3 rounded-full text-eco hover:bg-eco hover:text-white transition-colors">
